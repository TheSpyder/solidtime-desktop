...
// flow; consulted by both the workday monitor (when to prompt, boundary
// crossings) and the idle monitor.
...
/**
 * True if both moments fall within the same workday window (same calendar day
 * and both inside the window). A block spanning outside this is a workday
 * boundary crossing.
 */
